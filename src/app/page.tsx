...
export default function HomePage() {
  ...
  const handleFoundItemSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchId.trim()) {
      window.location.href = `/found?id=${searchId.trim().toUpperCase()}`;
    }
  };
      ...
      <section className="bg-blue-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div onSubmit={handleFoundItemSearch} className="max-w-md mx-auto">
